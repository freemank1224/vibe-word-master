  ...
  const supabaseAnonKey = getEnv('VITE_SUPABASE_ANON_KEY') || getEnv('SUPABASE_ANON_KEY');
    ...
    return {
      ...
      define: {
        ...
        'process.env.PRIMARY_IMAGE_GEN_BASE_URL': JSON.stringify(getEnv('PRIMARY_IMAGE_GEN_BASE_URL')),
        'process.env.PRIMARY_IMAGE_GEN_API_KEY': JSON.stringify(getEnv('PRIMARY_IMAGE_GEN_API_KEY')),
        'process.env.PRIMARY_IMAGE_GEN_MODEL': JSON.stringify(getEnv('PRIMARY_IMAGE_GEN_MODEL', 'gpt-image-2')),
        'process.env.BACKUP_IMAGE_GEN_BASE_URL': JSON.stringify(getEnv('BACKUP_IMAGE_GEN_BASE_URL')),
        'process.env.BACKUP_IMAGE_GEN_API_KEY': JSON.stringify(getEnv('BACKUP_IMAGE_GEN_API_KEY')),
        'process.env.BACKUP_IMAGE_GEN_MODEL': JSON.stringify(getEnv('BACKUP_IMAGE_GEN_MODEL', 'ernie-image')),
        'process.env.IMAGE_GEN_MODEL': JSON.stringify(getEnv('IMAGE_GEN_MODEL', 'gpt-image-2')),
