...
export const buildSceneDirectorSystemPrompt = (): string => {
  ...
  return [
    ...
    '',
    'GOOD sentences (scene description, the word is embedded naturally):',
    '  "A glossy red apple sits on the wooden kitchen counter."',
    '  "Two children run across the wet grass as the rain begins to fall."',
    '  "An angry chef slams his spoon onto the stove."',
    '',
    ...
    '  "In this scene there is an apple."            ← filler template (zero scene info)',
